...
def main() -> int:
    ...
    parser.add_argument("--out-json", default=str(data_reports_output_path("low_coverage_story_report.json", project_root=REPO_ROOT)))
    parser.add_argument("--out-md", default=str(data_reports_output_path("low_coverage_story_report.md", project_root=REPO_ROOT)))
