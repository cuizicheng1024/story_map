...
DEFAULT_TESTS = [
    "tests/unit/test_env_aliases.py",
    "tests/unit/test_output_paths.py",
    "tests/integration/test_artifacts.py",
    "tests/integration/test_static_service.py",
    ...
    "tests/unit/test_story_agent_runtime.py",
    "tests/unit/test_story_agent_graph.py",
    "tests/unit/test_story_agent_router.py",
    "tests/unit/test_profile_page_template.py",
    "tests/data/test_validate_story_markdown.py",
]
