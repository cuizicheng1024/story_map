...
def test_render_all_people_html_defaults_to_pure(tmp_path, monkeypatch):
    module = importlib.import_module("cli.generate_pure_story_map")
    captured = {}
...
def test_render_missing_people_html_defaults_to_pure(tmp_path, monkeypatch):
    module = importlib.import_module("cli.generate_pure_story_map")
    captured = {}
...
def test_render_changed_people_html_defaults_to_pure(tmp_path, monkeypatch):
    module = importlib.import_module("cli.generate_pure_story_map")
    captured = {}
...
def test_main_render_all_falls_back_to_pure_when_mode_is_empty(monkeypatch):
    module = importlib.import_module("cli.generate_pure_story_map")
    captured = {}
