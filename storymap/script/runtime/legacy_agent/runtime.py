...
try:
    from ..task_schema import AggregatedRuntimeMetadata, AgentRuntimeMetadata, normalize_agent_runtime_metadata, normalize_aggregated_runtime_meta
except ImportError:
    from runtime.task_schema import AggregatedRuntimeMetadata, AgentRuntimeMetadata, normalize_agent_runtime_metadata, normalize_aggregated_runtime_meta
