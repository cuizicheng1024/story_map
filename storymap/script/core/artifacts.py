...
from .project_paths import project_root_path, story_artifacts_dir_path, story_md_dir_path
...
def refresh_stellar_homepage(person: str = "") -> Dict[str, object]:
    ...
    return {
        ...
        "summary_index_path": os.path.join(_project_root(), "data", "corpus", "people_summary_index.json"),
        "work_summary_index_path": os.path.join(_project_root(), "data", "corpus", "work_summary_index.json"),
